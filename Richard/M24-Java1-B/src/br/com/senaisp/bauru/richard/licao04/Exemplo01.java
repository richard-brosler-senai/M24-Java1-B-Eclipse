...
public class Exemplo01 {
	...
	public static void main(String[] args) {
		...
		if (nome1.compareTo(nome2)>0) {
			System.out.println("Nome1 é maior que nome 2 - "+nome1.compareTo(nome2));
		}
		if (nome1.compareTo(nome2)<0) {
			System.out.println("Nome2 é maior que nome 1 - "+nome1.compareTo(nome2));
		}
		if (nome1.compareTo(nome2)==0) {
			System.out.println("Nome1 é igual nome 1 - " + nome1.compareTo(nome2));
		}
